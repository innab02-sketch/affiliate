...
ANTHROPIC_API_KEY = os.environ.get("ANTHROPIC_API_KEY", "sk-ant-xxxxxxxxxxxxxxxxxxxxx")

# מודל Claude לשימוש. דגמים מומלצים (זול ומהיר): claude-3-5-haiku-latest
# לאיכות גבוהה יותר: claude-3-5-sonnet-latest
